        ...
        <div className='mt-12'>
            <div className='flex'>
                <div className='absolute left-1'>
                    <Lottie className='w-48  sm:w-48 sm:absolute sm:left-96 sm:ml-12' animationData={Educationanim} />
                </div>
                <div className='ml-24'>
                    <h1 className='text-white ml-6 font-black text-5xl mt-8  md:text-7xl sm:absolute sm:left-96 sm:ml-44' ><span className="text-cyan-500 text-7xl">E</span>ducatio<span className='text-cyan-500'>n</span></h1>
                </div>
            </div>
            <div className='sm:flex sm:mt-28'>
                <div className='mt-24 ml-9 sm:ml-32 sm:w-52'>
